      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            padding: '32px 24px 36px', textAlign: 'center', color: '#fff',
          }}>
            <h2 style={{ fontSize: '22px', fontWeight: 700, margin: '0 0 8px' }}>School ERP</h2>
            <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.85)', margin: '0 0 18px', lineHeight: 1.5, maxWidth: '220px', marginLeft: 'auto', marginRight: 'auto' }}>
