    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 py-6.5">
        <NavLink to="/admin/home" style={{
          ...
          <h1 style={{ color: 'white', fontSize: 28, fontWeight: 'bold' }}>School ERP</h1>
        </NavLink>
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/Academics' ||
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/student' ||
                      ...
                      >
                        ...
                        >
                          <path
                            d="M9 1.5C4.5 1.5 4.5 5.5 4.5 5.5C4.5 6.5 4.8 7.5 5.5 7.5C6.2 7.5 6.5 6.5 6.5 6.5C6.5 5.5 8.5 5.5 9 5.5C9.5 5.5 11.5 5.5 11.5 6.5C11.5 6.5 11.8 7.5 12.5 7.5C13.2 7.5 13.5 6.5 13.5 5.5C13.5 5.5 13.5 1.5 9 1.5ZM9 8.5C6.8 8.5 4.5 9.5 4.5 11V12.5H13.5V11C13.5 9.5 11.2 8.5 9 8.5ZM3.5 13V15.5C3.5 15.9 3.8 16.2 4.1 16.2H13.9C14.2 16.2 14.5 15.9 14.5 15.5V13H3.5Z"
                            fill="currentColor"
                          />
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/exam' ||
                      ...
                      >
                        ...
                        >
                          <path
                            d="M2 2.5H16C16.5523 2.5 17 2.94772 17 3.5V14.5C17 15.0523 16.5523 15.5 16 15.5H2C1.44772 15.5 1 15.0523 1 14.5V3.5C1 2.94772 1.44772 2.5 2 2.5Z"
                            stroke="currentColor"
                            stroke-width="1.5"
                            fill="none"
                          />
                          ...
                          />
                          <path
                            d="M4.5 14L7.5 11.5L10.5 14"
                            stroke="currentColor"
                            stroke-width="1.5"
                            stroke-linecap="round"
                          />
                          <path
                            d="M12 3L15 0L16 1L13 4"
                            stroke="currentColor"
                            stroke-width="1.5"
                            stroke-linecap="round"
                          />
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/Fees' ||
